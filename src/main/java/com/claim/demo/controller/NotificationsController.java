...
import com.claim.demo.service.NotificationServiceI;
...
public class NotificationsController {
    @Autowired
    private NotificationServiceI notificationService;  // Service layer handling the business logic for notifications.
